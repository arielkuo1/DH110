...
![musictheory.net original](https://arielkuo1.github.io/DH110/blob/main/Assignment%201/musictheory-screenshot.png)
...
[Full Usability Testing](https://github.com/arielkuo1/DH110/tree/main/Assignment%202)
...
[Full Contextual Inquiry](https://github.com/arielkuo1/DH110/tree/main/Assignment%203)
...
Overall, creating the personas and usage scenarios really helped me think through the logistics of the tasks. Imagining Will going through his first lesson on musictheory.net was helpful for me to design the wireflow related to that task.

[Full Personas + Usage Scenarios](https://github.com/arielkuo1/DH110/tree/main/Assignment%204)

### Low-Fidelity Prototype

The purpose of prototyping in design helps the designer envision how the user will interact with the product to complete tasks. This step in the creation process brings ideas to practical actionable steps. Creating low-fidelity prototypes are an effective, inexpensive way to test the usability of the proposed product. In this project, I created hand-drawn wireflows to exemplify going through two tasks, one lesson and one exercise. Then, I asked a test subject to draw on the wireflow as if they were going through the task, to see what steps they would take.
...
[Full Lo-fi Prototype](https://github.com/arielkuo1/DH110/tree/main/Assignment%205)
...
[Full Interface Design](https://github.com/arielkuo1/DH110/tree/main/Assignment%206)
